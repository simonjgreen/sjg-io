...
<img src="/first-leather-attempts.jpg" alt="My first experiments in leatherworking, tray included" style={{ display: 'block', margin: '2rem auto', borderRadius: '0.5rem', maxWidth: '800px', width: '100%' }} />

*Early leatherworking attempts: a valet tray and various components in progress*
...
<img src="/willow-in-the-woods.jpg" alt="Chilling in the forest while Willow sketches" style={{ display: 'block', margin: '2rem auto', borderRadius: '0.5rem', maxWidth: '800px', width: '100%' }} />

*Time in the woods: a reset from work, where the stakes are simple and immediate*
...
<img src="/lily-opening-a-geocache.jpg" alt="Lily delighted by her recent Geocache find. She especially loves taking things to swap for the items others leave in the containers." style={{ display: 'block', margin: '2rem auto', borderRadius: '0.5rem', maxWidth: '800px', width: '100%' }} />

*Geocaching adventures: instant adventures that start at your front door*
