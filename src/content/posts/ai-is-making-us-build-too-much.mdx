...
description: "AI has made code, tests, policy, documentation, and organisational machinery almost free to produce. It has not made any of them free to own."
date: 2026-09-03
tags: ["ai", "agents", "systems-thinking", "organisation-design", "leadership", "productivity"]
image: "../../assets/over-engineered-much.webp"
draft: false
---
...
I have been thinking about this since reading Steve Yegge's [*Fences, not Sandboxes*](https://yegge.ai/essays/fences-not-sandboxes/).
...
Yegge's earlier article, [*The Shape of Things to Come*](https://yegge.ai/essays/the-shape-of-things-to-come/), describes his previous harness, Gas Town, effectively collapsing because its model developed what he called a "just two more things" habit. It kept improving the harness instead of converging on the real work.
